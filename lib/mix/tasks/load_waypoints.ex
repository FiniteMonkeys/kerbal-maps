defmodule Mix.Tasks.LoadWaypoints do
  ...
  defp marker_icon("ContractPacks/AnomalySurveyor/Icons/arch"), do: ~S({"prefix":"fas","name":"archway"})
  defp marker_icon("ContractPacks/AnomalySurveyor/Icons/monolith"), do: ~S({"prefix":"fas","name":"monument"})
  defp marker_icon("ContractPacks/AnomalySurveyor/Icons/pyramids"), do: ~S({"prefix":"fas","name":"gopuram"})
